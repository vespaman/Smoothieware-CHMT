...
* 20251020: Added support for external closed loop stepperdrivers for X and Y.
* 20251020: Added support for vacuum pump inhibit input. When active, the vacuum pump/ejector can be switched on/off using an input (PC0 (ain4 on PCB)) as per config.default.
