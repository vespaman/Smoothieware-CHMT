...
#define inpos_pin_checksum                   CHECKSUM("inpos_pin")
...
void Extruder::config_load()
{
    ...
    Pin step_pin, dir_pin, en_pin, inpos_pin;
    ...
    inpos_pin.from_string(THEKERNEL->config->value(extruder_checksum, this->identifier, inpos_pin_checksum         )->by_default("nc" )->as_string())->as_output();
    ...
    stepper_motor = new StepperMotor(step_pin, dir_pin, en_pin, inpos_pin);
